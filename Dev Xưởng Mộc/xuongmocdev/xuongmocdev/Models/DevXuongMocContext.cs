...
public partial class DevXuongMocContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-7CPIFL9\\SQLEXPRESS;Database=DevXuongMoc;Integrated Security=True;MultipleActiveResultSets=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C882445063AB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27EE0DB550");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC2777CF0C78");
